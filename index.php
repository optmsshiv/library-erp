...
<script>
    ...
    <div class="sc" style="--ca:var(--ac);padding:0;overflow:hidden;display:flex;transition:box-shadow .2s,transform .2s" onmouseenter="this.style.transform='translateY(-2px)';this.style.boxShadow='0 8px 24px rgba(0,0,0,0.13)'" onmouseleave="this.style.transform='';this.style.boxShadow=''"><div style="background:#185FA5;width:64px;display:flex;align-items:center;justify-content:center;flex-shrink:0"><div style="width:46px;height:46px;border-radius:50%;background:rgba(255,255,255,0.12);display:flex;align-items:center;justify-content:center"><span class="mi xl" style="color:#E6F1FB">school</span></div></div><div style="padding:10px 12px;display:flex;flex-direction:column;gap:4px;flex:1;align-items:flex-end"><div style="font-size:26px;font-weight:700;color:var(--tx);line-height:1">${s.length}</div><div style="width:100%;height:1px;background:var(--br)"></div><div style="font-size:12px;color:var(--tx3);font-weight:500">Total Students</div><div style="display:flex;align-items:center;gap:5px"><span class="mi" style="font-size:13px;color:var(--em)">arrow_upward</span><span style="font-size:12px;color:var(--em);font-weight:600">12%</span><span style="font-size:12px;color:var(--tx3)">this month</span></div></div></div>
