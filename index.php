...
<script>
    ...
    ${(()=>{
      ...
      return `<div class="sc" style="--ca:var(--vi);padding:12px 16px;min-width:0;grid-column:1/-1;display:flex;align-items:center;gap:20px">
        <div style="flex-shrink:0">
          <div style="font-size:10px;font-weight:700;color:var(--tx3);letter-spacing:.8px;text-transform:uppercase;font-family:var(--fm);margin-bottom:2px">Monthly Expenses</div>
          <div style="font-size:20px;font-weight:800;color:var(--tx);line-height:1.1;font-family:var(--fd);margin-bottom:4px">₹${curTotal.toLocaleString('en-IN')}</div>
        ...
        <svg width="100%" height="60" viewBox="0 0 ${W} ${H}" preserveAspectRatio="none" style="display:block;overflow:hidden;flex:1">
          <defs>
